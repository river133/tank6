...
import com.mashibing.tankFactory.abstractfactory.GameFactory;
import com.mashibing.tankFactory.abstractfactory.RectFactory;
...
public class TankFrame extends Frame {
    ...
    public List<Tank> tanks = new ArrayList<>();//敌方坦克容器
